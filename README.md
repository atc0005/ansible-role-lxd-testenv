...
| `lxd_containers_image_source`                      | `ubuntu/xenial/amd64`                | Default container image to use when spinning up new containers for testing purposes. Should be overridden in a playbook, `group_vars` or `host_vars`                                                                                                                                                                     |
